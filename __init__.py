...
gettext.bindtextdomain("djheros_connector", LOCALE_DIR)
gettext.textdomain("djheros_connector")
_ = gettext.gettext
...
class Plugin(BasePlugin):
    def __init__(self, *args, **kwargs):
        ...
        self.log(_("🔄 Loading passe_mon_truc_connector plugin..."))
    ...
    def loaded_notification(self):
        ...
        self.log(_("🔔 Plugin passe_mon_truc_connector loaded."))
    ...
    def show_window(self):
        ...
        self.window = Gtk.Window(title=_("passe_mon_truc_connector"))
        ...
        url_label = Gtk.Label(label=_("enter the adress (ex: https://passemontruc.kodcast.com/playlists/0fgij7d7) :"))
